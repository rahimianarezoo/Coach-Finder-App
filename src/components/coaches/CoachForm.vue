<template>
    <form @submit.prevent="submitForm">
        ...
        <div class="form-control" :class="{invalid: !rate.isValid}">
            ...
            <p v-if="!rate.isValid">Rate must be gretaer than zero.</p>
        </div>
        <div class="form-control">
            ...
            <p v-if="!areas.isValid">At least must be one expertise must be selected</p>
        </div>
        <p v-if="!formIsValid" @blur="clearValidity('areas')" >
